...
<ul class="layui-nav layui-nav-tree layui-nav-side nav-bar">
  <li class="layui-nav-item">
   <img class="nav-bar-avar layui-anim layui-anim-rotate " src="static/images/reg.jpg"/>
   <h1 class="nav-bar-avar-font"><%=user.getUser() %></h1>
   <h2 class="text-center" >密码签名</h1>
   <h2 class="text-center"><%=user.getPwdmd5()%></h2>
  </li>
  <li class="layui-nav-item">
...
<div class="content-card-panel">
 ...
 <div class="content-card-item">
  ...
  <h1><%=names[i]%></h1>
  <h1>数量：<%=items.get(i).getNumber() %></h1>
  </div>
 </div>
 <%} %>
</div>
